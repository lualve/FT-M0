...
function obtenerMayor(x, y) {
  // "x" e "y" son números enteros (int).     (1,2,3)
...
function mayoriaDeEdad(edad) {
  //Determinar si la persona según su edad puede ingresar a un evento.         (4,5)
...
function conection(status) {
  //Recibimos un estado de conexión de un usuario representado por un valor numérico.    (6)
...
function saludo(idioma) {
  // Devuelve un saludo en tres diferentes lenguajes:      (7,8,9,10)
...
function colors(color) {
  //La función recibe un color. Devolver el string correspondiente:       (11,12)
...
function esDiezOCinco(numero) {
  // Devuelve "true" si "numero" es 10 o 5         (13,14)
...
function estaEnRango(numero) {
  // Devuelve "true" si "numero" es menor que 50 y mayor que 20        (15,16)
  // De lo contrario, devuelve "false"
  // Tu código:
...
function esEntero(numero) {
  // Devuelve "true" si "numero" es un entero (int/integer)        (17,18,19,20)
  // Ejemplo: 0.8 -> false
  // Ejemplo: 1 -> true
  // Ejemplo: -10 -> true
  // De lo contrario, devuelve "false"
  ...
  // Tu código:
  if(Math.floor(numero)!= numero) return false;
  else return true;
}
